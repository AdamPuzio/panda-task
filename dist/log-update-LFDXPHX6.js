...
var _chunkQNLRFL5Jjs = require('./chunk-QNLRFL5J.js');
...
var require_mimic_fn = _chunkEX5VYLFXjs.__commonJS.call(void 0, {
...
var require_onetime = _chunkEX5VYLFXjs.__commonJS.call(void 0, {
...
var require_signals = _chunkEX5VYLFXjs.__commonJS.call(void 0, {
...
var require_signal_exit = _chunkEX5VYLFXjs.__commonJS.call(void 0, {
  "node_modules/signal-exit/index.js"(exports, module) {
    ...
    if (!processOk(process6)) {
      ...
      assert = _chunkEX5VYLFXjs.__require.call(void 0, "assert");
      signals = require_signals();
      isWin = /^win/i.test(process6.platform);
      EE = _chunkEX5VYLFXjs.__require.call(void 0, "events");
...
var isTerminalApp = !isBrowser && _process2.default.env.TERM_PROGRAM === "Apple_Terminal";
var isWindows = !isBrowser && _process2.default.platform === "win32";
var cwdFunction = isBrowser ? () => {
  throw new Error("`process.cwd()` only works in Node.js, not the browser.");
} : _process2.default.cwd;
var ansiEscapes = {};
...
_chunkEX5VYLFXjs.init_cjs_shims.call(void 0, );
var import_onetime = _chunkEX5VYLFXjs.__toESM.call(void 0, require_onetime(), 1);
var import_signal_exit = _chunkEX5VYLFXjs.__toESM.call(void 0, require_signal_exit(), 1);
...
function stringWidth(string, options = {}) {
  ...
  for (const { segment: character } of segmenter.segment(string)) {
    ...
    width += _chunkQNLRFL5Jjs.eastAsianWidth.call(void 0, codePoint, eastAsianWidthOptions);
  }
  return width;
}
...
function isFullwidthCodePoint(codePoint) {
  ...
  return _chunkQNLRFL5Jjs.eastAsianWidth.call(void 0, codePoint) === 2;
}
...
var fitToTerminalHeight = (stream, text) => {
  const terminalHeight = _nullishCoalesce(stream.rows, () => ( defaultTerminalHeight));
...
var logUpdate = createLogUpdate(_process2.default.stdout);
var log_update_default = logUpdate;
var logUpdateStderr = createLogUpdate(_process2.default.stderr);




exports.createLogUpdate = createLogUpdate; exports.default = log_update_default; exports.logUpdateStderr = logUpdateStderr;
